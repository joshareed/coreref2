                    ...
                    <table>
                        <tbody>
	                        <tr class="prop">
                                ...
                                <td valign="top" class="value ${errors.firstName ? 'errors' : ''}">
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${errors.lastName ? 'errors' : ''}">
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${errors.email ? 'errors' : ''}">
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${errors.password ? 'errors' : ''}">
